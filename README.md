...
# Getting Started
1. `$ git clone https://github.com/gabriellabrown/brownwedding.git` - clone this project to your computer
2. `$ cd brownwedding` - go inside the project directory
...
# Documentation
I followed code found here: https://github.com/rampatra/wedding-website.git which is also associated with this 
[blog post describing all the features of this wedding website](https://blog.rampatra.com/wedding-website) and how to
customize each of them according to your needs.

# About Me
Hello, my name is Gabriella. I am a Software Engineer Specialist at American Century Investments and getting married April 2026! I thought it would be fun to dust off some of my website development skills I learned in college and put my creativity/efforts into something cute for my fiance, Brandon! Hope you all enjoy as well!
